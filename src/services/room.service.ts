...
export class RoomService {
    ...
    static getSubscribersInRoom = async (roomId: string, tenantId: string) => {
        try {
    ...
    static getSubscribersInAllRooms = () => {
        try {
    ...
    static disconnectClientFromAllRooms = (data: any) => {
        const { socket } = data;
        ...
        if (clientSubscriptionMap.get(client) === undefined) {
            ...
            roomArray.forEach((room: string) => {
                ...
                socket.leave(room);
                RoomService.removeClientFromRoom({ room, socketId: client });
            });
    ...
    static addClientToRoom = (data: RoomSocketPayload) => {
    ...
    static removeClientFromRoom = (data: RoomSocketPayload) => {
        const { room, socketId } = data;
    ...
    static addRoomToClient = (data: RoomSocketPayload) => {
        const { room, socketId } = data;
    ...
    static removeRoomFromClient = (data: RoomSocketPayload) => {
        const { room, socketId } = data;
        if (clientSubscriptionMap.get(socketId) === undefined) {
