...
var deepgram = getDeepgramApiKey() != undefined ? createClient(getDeepgramApiKey()) : null;
export var authService = function (payload) { return __awaiter(void 0, void 0, void 0, function () {
    var keyResult, error_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                console.log("The service code is: ".concat(payload.serviceId));
                ...
                return [4 /*yield*/, deepgram.manage.createProjectKey(getDeepgramProjectId(), {
            ...
            case 2:
                error_1 = _b.sent();
                console.error("Caught error in auth: ".concat(error_1));
                return [2 /*return*/, {
                        success: false,
                        statusCode: 400,
                        message: "Key is missing or incorrect",
